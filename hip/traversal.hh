...
void cuda_dtt(FMM<T>* fmm, FMM<T>* h_fmm, FMM<T>* d_fmm)
{
  ...
  timer.start();
  hipLaunchKernelGGL(p2p_kernel, dim3(p2p_num_nodes), dim3(128), 0, 0, d_fmm, d_p2p_nodes, d_p2p_deps_array,
  ...
  timer.start();
  hipLaunchKernelGGL(m2l_kernel, dim3(m2l_num_nodes), dim3(32), 0, 0, d_fmm, d_m2l_nodes, d_m2l_deps_array,
